...
<div class="page_content">
    ...
    @endif
    <div class="form">
        <form class="form-horizontal" action="{{route('blood-types.update',$blood_type->id)}}"  method="post">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="input0" class="col-sm-2 control-label bring_right left_text">اسم فصيلة الدم</label>
                <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" value="{{$blood_type->name}}"  placeholder="اسم فصيلة الدم">
                    @error('name')
