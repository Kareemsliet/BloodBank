...
<div class="page_content">
    ...
    @endif
    <div class="form">
        <form class="form-horizontal" action="{{route('blood-types.store')}}"  method="post">
            @csrf
            @method('POST')
            <div class="form-group">
                <label for="input0" class="col-sm-2 control-label bring_right left_text">اسم فصيلة الدم</label>
                <div class="col-sm-10">
                    <input type="text" name="name" value="{{old('name')}}" class="form-control"  placeholder="اسم فصيلة الدم">
                    @error('name')
