...
<div class="page_content">
    ...
    @endif
    <div class="form">
        <form class="form-horizontal" action="{{route('states.store')}}"  method="post">
            @csrf
            @method('POST')
            <div class="form-group">
                <label for="input0" class="col-sm-2 control-label bring_right left_text">اسم المحافظة</label>
                <div class="col-sm-10">
                    <input type="text" name="name" value="{{old('name')}}" class="form-control"  placeholder="اسم المحافظة">
                    @error('name')
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{old('code')}}" name="code" class="form-control"  placeholder="كود المحافظة" />
                    @error('code')
                    <div style="font-size:16px;color:red">{{$message}}</div>
                    @enderror
                </div>
